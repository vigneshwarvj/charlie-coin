  ...
  <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
    <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
      <div class="md:w-[316px]">
        ...
        <a href="#" class="hover:scale-110"  loading="lazy" aria-label="Find us on LinkedIn"
            target="_blank" rel="noopener" decoding="async" data-nimg="1">
      ...
      <div class="md:w-[316px]">
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="#" class="font-Inter text-[16px] font-medium text-[#fff]">Sub Nerul, Mumbia,
              India, 123456</a>
